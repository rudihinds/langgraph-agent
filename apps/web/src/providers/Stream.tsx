...
//         <div className="flex flex-col max-w-3xl border rounded-lg shadow-lg animate-in fade-in-0 zoom-in-95 bg-background">
//           <div className="flex flex-col gap-2 p-6 border-b mt-14">

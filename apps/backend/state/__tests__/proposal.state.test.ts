  ...
  describe("State Reducers", () => {
    describe("sectionsReducer", () => {
      it("should add a new section", () => {
        ...
        const newSection: Partial<SectionData> = {
          id: "introduction",
        ...
        expect(result.introduction?.status).toBe("queued");
      ...
      it("should update an existing section", () => {
        ...
        const update: Partial<SectionData> = {
          id: "introduction",
          content: "New content",
          status: "approved",
        };
        ...
        expect(result.introduction?.status).toBe("approved");
        expect(result.introduction?.lastUpdated).not.toBe("2023-01-01T00:00:00Z");
      });
    ...
    describe("State Validation", () => {
      it("should validate a complete state", () => {
        const validState: OverallProposalState = {
          ...
          requiredSections: ["introduction", "methodology"],
